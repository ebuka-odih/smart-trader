      ...
      <div class="flex items-center justify-start">
        ...
        <a href="{{ route('index') }}" class="flex ml-2 md:mr-24">
          @if(\App\Helpers\WebsiteSettingsHelper::hasTextLogo())
              <!-- Text Logo -->
              <div class="h-8 flex items-center justify-center px-3 py-1 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg mr-3">
          ...
          @endif
          <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">{{ \App\Helpers\WebsiteSettingsHelper::getSiteName() }}</span>
        </a>
