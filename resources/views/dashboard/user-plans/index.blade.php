...
<div class="space-y-8">
    ...
    <div class="text-center">
        <h1 class="text-4xl font-bold text-white mb-2">My Plan Subscriptions</h1>
        <p class="text-xl text-gray-400">Manage your active and past plan subscriptions</p>
    </div>
    ...
    <div class="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-700">
            <h2 class="text-xl font-semibold text-white">All Plan Subscriptions</h2>
        </div>
                        ...
                        @foreach($userPlans as $userPlan)
                            <tr class="hover:bg-gray-700">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-300">
                                    ...
                                    @if($userPlan->isExpiringSoon())
                                        <span class="ml-2 text-xs text-yellow-400">(Expiring soon)</span>
                                    @endif
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                    <div class="flex space-x-2">
                                        ...
                                        @endif
                                        <form method="POST" action="{{ route('user.plans.destroy', $userPlan) }}" class="inline">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="text-gray-400 hover:text-gray-300" onclick="return confirm('Are you sure you want to delete this plan subscription?')">
                                                Delete
                                            </button>
                                        </form>
                                    </div>
        ...
        @else
            <div class="px-6 py-12 text-center">
                ...
                <h3 class="text-lg font-medium text-white mb-2">No Plan Subscriptions</h3>
