...
<div class="space-y-8">
    ...
    <div class="text-center">
        <h1 class="text-4xl font-bold text-white mb-2">My Active Plans</h1>
        <p class="text-xl text-gray-400">View your currently active plan subscriptions</p>
    </div>
    ...
    @if($activePlans->count() > 0)
        @foreach($activePlans as $planType => $plans)
            <div class="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden">
                <div class="px-6 py-4 border-b border-gray-700">
                    <h2 class="text-xl font-semibold text-white">{{ ucfirst($planType) }} Plans</h2>
                </div>
    ...
    @else
        <div class="bg-gray-800 rounded-xl border border-gray-700 overflow-hidden">
            <div class="px-6 py-12 text-center">
                ...
                <h3 class="text-lg font-medium text-white mb-2">No Active Plans</h3>
                <p class="text-gray-400 mb-4">You don't have any active plan subscriptions.</p>
