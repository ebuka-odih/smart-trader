            ...
            <div class="bg-gray-800 rounded-lg border border-gray-700 p-6">
                ...
                <div id="livechat-widget" class="min-h-[400px] bg-gray-700 rounded-lg flex items-center justify-center">
                    <div class="text-center">
                        <div class="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4" style="background-color: {{ $livechatConfig['color'] }}">
                            <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path>
                            </svg>
                        </div>
                        <h3 class="text-white font-medium mb-2">Live Chat Available</h3>
                        <p class="text-gray-400 text-sm">{{ $livechatConfig['welcome_message'] ?: 'Click the chat button to start a conversation with our support team.' }}</p>
                    </div>
                </div>
            </div>
        </div>
